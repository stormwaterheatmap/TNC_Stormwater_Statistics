...
boxplots.resids2 <- function(myModel, myE, myForm) {
  aa <- coc2[, c("agency", "impervious", "paved", "roofs", "grass", "trees", "nodev", "pm25", "traffic", "slope", "devAge", "roof_RES", "roof_nonRES")]
  bb <- unique(aa)
  ...
  abline(0,0, col="gray")
  boxplot(myE~coc2$devAge, main="devAge", ylab="", xaxt="n", yaxt="n", col=colors_agency[as.numeric(bb[order(bb[,"devAge"]), "agency"])])
  abline(0,0, col="gray")
  boxplot(myE~coc2$roof_RES, main="roof_RES", ylab="", xaxt="n", yaxt="n", col=colors_agency[as.numeric(bb[order(bb[,"roof_RES"]), "agency"])])
  abline(0,0, col="gray")
  boxplot(myE~coc2$roof_nonRES, main="roof_nonRES", ylab="", xaxt="n", yaxt="n", col=colors_agency[as.numeric(bb[order(bb[,"roof_nonRES"]), "agency"])])
  abline(0,0, col="gray")
...
#function to plot best fit LME model line to a single predictor
