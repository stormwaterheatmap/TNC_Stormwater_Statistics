...
[^1]: Phase I Permittees include: cities of Tacoma and Seattle; King,
    ...
    (too different from all other Puget Sound
    watersheds).
...
|         | entage |                                                   |
+=========+========+===================================================+
| Total   | 0%     | 4 samples were field blanks misclassified as      |
| Copper  |        | ND's. Censored data percentage was calculated     |
|         |        | following removal of these 4 field blanks.        |
+---------+--------+---------------------------------------------------+
| Total   | 9.76%  |                                                   |
| K       |        |                                                   |
| jeldahl |        |                                                   |
...
| itrogen |        |                                                   |
+---------+--------+---------------------------------------------------+
| Total   | 1.17%  | 3 samples with high results were classified as    |
| Pho     |        | ND's, but should have been flagged as             |
| sphorus |        | "estimated". Censored data percentage was         |
|         |        | calculated following reclassification of these 3  |
|         |        | data points.                                      |
+---------+--------+---------------------------------------------------+
| Total   | 0.83%  |                                                   |
| Su      |        |                                                   |
...
+---------+--------+---------------------------------------------------+
| Total   | 0%     | 4 samples were field blanks misclassified as      |
| Zinc    |        | ND's. Censored data percentage was calculated     |
|         |        | following removal of these 4 field blanks         |
+---------+--------+---------------------------------------------------+
...
| **Layer**      | **ID**     | **Source**                                  |
+================+============+=============================================+
| urban          | urbRES     | Washington State Department of Commerce,    |
| residential    |            | Puget Sound Mapping Project                 |
+----------------+------------+---------------------------------------------+
| rural          | ruRES      |                                             |
| residential    |            |                                             |
+----------------+------------+---------------------------------------------+
...
| density        |            |                                             |
+----------------+------------+---------------------------------------------+
| urban          | r          | rooftop density applied to Washington State |
| residential    | oof_urbRES | Department of Commerce, Puget Sound Mapping |
| rooftops       |            | Project data                                |
+----------------+------------+---------------------------------------------+
| total          | r          |                                             |
| residential    | oof_totRES |                                             |
| rooftops       |            |                                             |
+----------------+------------+---------------------------------------------+
| intensive      | r          |                                             |
| urban rooftops | oof_intURB |                                             |
+----------------+------------+---------------------------------------------+
| intensive      | roof_      |                                             |
| urban +        | intURB_IND |                                             |
| industrial     |            |                                             |
...
| NO2            | no2        |                                             |
+----------------+------------+---------------------------------------------+
| carbon         | CO2_com    | Vulcan Carbon Dioxide Emissions data set    |
| emissions,     |            |                                             |
| commercial     |            |                                             |
+----------------+------------+---------------------------------------------+
| carbon         | CO2_res    |                                             |
...
| slope          | slope      |                                             |
+----------------+------------+---------------------------------------------+
| age of         | devAge     | Calculated value based on year of           |
...
$$
\ln(Copper) \sim rain + summer + sqrt.traffic + totRES
$$
...
$$
var(\epsilon_{ijk}) = \sigma^2_j * \exp^{2\delta * rain_{ik}}
$$
...
variance structures did not indicate a
strong benefit to using the more complex variance structure. As a
result, we used the simpler variance
...
$$
\ln(TKN) = 6.52 - 0.15*rain + 0.60*summer + 0.28*sqrt.CO2.road + 0.22*devAge2
$$
